...
workingDir <- "E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.4.Insect_Libraries_Filtered/5.4.2.Filter_10/"
setwd(workingDir)
getwd()
...
Bger1 <- readDNAStringSet("Bger1_filt10.fasta")
Bger1_seqs <- as.data.frame(Bger1)$x

Bger2 <- readDNAStringSet("Bger2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/B.germanica_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Ofas1 <- readDNAStringSet("Ofas1_filt10.fasta")
Ofas1_seqs <- as.data.frame(Ofas1)$x

Ofas2 <- readDNAStringSet("Ofas2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/O.fasciatus_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Apisum1 <- readDNAStringSet("Apisum1_filt10.fasta")
Apisum1_seqs <- as.data.frame(Apisum1)$x

Apisum2 <- readDNAStringSet("Apisum2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/A.pisum_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
draw.pairwise.venn(area1 = total_seq_Apisum1,area2 = total_seq_Apisum2,
                   ...
                   print.mode = c('raw', 'percent'), cex = 2.5, fill  = c("skyblue","mediumorchid"), cat.cex = 2.5, cat.pos = c(5, 360), cat.dist = c(-0.415, -0.395))
...
Tcas1 <- readDNAStringSet("Tcas1_filt10.fasta")
Tcas1_seqs <- as.data.frame(Tcas1)$x

Tcas2 <- readDNAStringSet("Tcas2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/T.castaneum_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Dvir1 <- readDNAStringSet("Dvir1_filt10.fasta")
Dvir1_seqs <- as.data.frame(Dvir1)$x

Dvir2 <- readDNAStringSet("Dvir2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/D.virgifera_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Amell1 <- readDNAStringSet("Amell1_filt10.fasta")
Amell1_seqs <- as.data.frame(Amell1)$x

Amell2 <- readDNAStringSet("Amell2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/A.mellifera_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Bterr1 <- readDNAStringSet("Bterr1_filt10.fasta")
Bterr1_seqs <- as.data.frame(Bterr1)$x

Bterr2 <- readDNAStringSet("Bterr2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/B.terrestris_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Pxyl1 <- readDNAStringSet("Pxyl1_filt10.fasta")
Pxyl1_seqs <- as.data.frame(Pxyl1)$x

Pxyl2 <- readDNAStringSet("Pxyl2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/P.xylostella_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Tni1 <- readDNAStringSet("Tni1_filt10.fasta")
Tni1_seqs <- as.data.frame(Tni1)$x

Tni2 <- readDNAStringSet("Tni2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/T.ni_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Aaeg1 <- readDNAStringSet("Aaeg1_filt10.fasta")
Aaeg1_seqs <- as.data.frame(Aaeg1)$x

Aaeg2 <- readDNAStringSet("Aaeg2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/A.aegypti_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
...
Mdom1 <- readDNAStringSet("Mdom1_filt10.fasta")
Mdom1_seqs <- as.data.frame(Mdom1)$x

Mdom2 <- readDNAStringSet("Mdom2_filt10.fasta")
...
png("E:/oscar/Documents/TFM/5.Filter_and_ReplicateLibraries/5.3.Replicates_Filter/5.3.2.Filter_10/M.domestica_filtered_replicates_filt_10.png",width = 1500,height = 1500,res = 150)
